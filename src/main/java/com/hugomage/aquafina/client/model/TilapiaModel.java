...
public class TilapiaModel<T extends TilapiaEntity> extends EntityModel<T>  {
	...
	public TilapiaModel() {
        ...
        up_fin.setPos(0.0F, -3.0F, 2.0F);
        fishe.addChild(up_fin);
        up_fin.texOffs(0, 13).addBox(0.0F, -2.0F, -2.0F, 0.0F, 3.0F, 5.0F, 0.0F, false);

        down_fins = new ModelRenderer(this);
        down_fins.setPos(0.0F, 2.0F, 2.0F);
        fishe.addChild(down_fins);
        down_fins.texOffs(0, 13).addBox(0.0F, 0.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, false);

        cube_r1 = new ModelRenderer(this);
        cube_r1.setPos(0.0F, 0.0F, -2.0F);
        down_fins.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.0F, 0.0F, -0.3054F);
        cube_r1.texOffs(0, 0).addBox(0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.0F, false);

        cube_r2 = new ModelRenderer(this);
        cube_r2.setPos(0.0F, 0.0F, -2.0F);
        down_fins.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.0F, 0.0F, 0.3054F);
        cube_r2.texOffs(4, 0).addBox(0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.0F, false);

        left_fin = new ModelRenderer(this);
        left_fin.setPos(1.0F, 0.0F, -2.0F);
        ...
        cube_r3.texOffs(6, 13).addBox(0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, false);

        right_fin = new ModelRenderer(this);
        right_fin.setPos(-1.0F, 0.0F, -2.0F);
        ...
        cube_r4.texOffs(11, 13).addBox(0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, false);
        ...
        fishe.addChild(body);
        body.texOffs(0, 0).addBox(-1.0F, -3.0F, -3.0F, 2.0F, 5.0F, 7.0F, 0.0F, false);
        body.texOffs(12, 0).addBox(-1.0F, -2.0F, -4.0F, 2.0F, 3.0F, 1.0F, 0.0F, false);
    }
