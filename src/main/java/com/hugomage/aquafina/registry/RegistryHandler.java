package com.hugomage.aquafina.registry;

import com.hugomage.aquafina.Aquafina;
import com.hugomage.aquafina.blocks.StuffedPiranha;
...
public class RegistryHandler {
    ...
    // Items
    public static final RegistryObject<Item> RAW_ANGELFISH = ITEMS.register("raw_angelfish", FishItem::new);
    public static final RegistryObject<Item> RAW_FOOTBALL_FISH = ITEMS.register("raw_football_fish", FishItem::new);
    public static final RegistryObject<Item> RAW_FOXFACE_FISH = ITEMS.register("raw_foxface_fish", FishItem::new);
    public static final RegistryObject<Item> RAW_ROYAL_GRAMMA = ITEMS.register("raw_royal_gramma", FishItem::new);
    public static final RegistryObject<Item> RAW_STARFISH = ITEMS.register("raw_starfish", FishItem::new);
    public static final RegistryObject<Item> SPIDER_CRAB_LEG = ITEMS.register("spider_crab_leg", ItemBase::new);
    public static final RegistryObject<Item> FULL_SPIDER_CRAB_LEG = ITEMS.register("meaty_spider_crab_leg", FriedToeBiterLeg::new);
    public static final RegistryObject<Item> RAW_PIRANHA = ITEMS.register("raw_piranha", FishItem::new);
    public static final RegistryObject<Item> CAVIAR = ITEMS.register("beluga_caviar", FishItem::new);
    public static final RegistryObject<Item> RAW_TILAPIA = ITEMS.register("raw_tilapia", FishItem::new);
    public static final RegistryObject<Item> FRIED_TOEBITER = ITEMS.register("bucket_of_fried_toe_biter", FriedToeBiterBucket::new);
    public static final RegistryObject<Item> RAW_STINGRAY = ITEMS.register("raw_stingray_slice", RawStingrayItem::new);
    ...
    public static final RegistryObject<Item> COOKED_STINGRAY = ITEMS.register("cooked_stingray_slice", CookedStingrayItem::new);
    public static final RegistryObject<Item> PIRANHA_MEAL = ITEMS.register("piranha_meal", ItemBase::new);
    public static final RegistryObject<Item> RAW_TIGERFISH = ITEMS.register("raw_tigerfish", FishItem::new);
    ...
    public static final RegistryObject<Item> FOXFACE_BUCKET = ITEMS.register("bucket_of_foxface_fish", () -> new FishBucketItem(ModEntityTypes.FOXFACE, () -> Fluids.WATER, new Item.Properties().tab(ItemGroup.TAB_MATERIALS).stacksTo(1)));
    ...
    public static final RegistryObject<Item> TRIOP_BUCKET = ITEMS.register("bucket_of_triops", () -> new FishBucketItem(ModEntityTypes.TRIOP, () -> Fluids.WATER, new Item.Properties().tab(ItemGroup.TAB_MATERIALS).stacksTo(1)));
    ...
    // Blocks
    public static final RegistryObject<StuffedPiranha> STUFFED_PIRANHA = BLOCKS.register("stuffed_piranha", com.hugomage.aquafina.blocks.StuffedPiranha::new);
