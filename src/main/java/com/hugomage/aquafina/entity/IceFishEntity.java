...
public class IceFishEntity extends AbstractGroupFishEntity {
    public IceFishEntity(EntityType<? extends IceFishEntity> p_i49856_1_, World p_i49856_2_) {
        super(p_i49856_1_, p_i49856_2_);
    }
    private static final DataParameter<Integer> VARIANT = EntityDataManager.defineId(IceFishEntity.class, DataSerializers.INT);
    ...
    public ItemStack getPickedResult(RayTraceResult target) {
        return new ItemStack(RegistryHandler.ICEFISH_SPAWN_EGG.get());
    }

    @Override
    protected void registerGoals() {
        this.goalSelector.addGoal(1, new IceFishEntity.SwimGoal(this));
    ...
    static class SwimGoal extends RandomSwimmingGoal {
        private final IceFishEntity fish;

        public SwimGoal(IceFishEntity fish) {
            super(fish, 2.0D, 40);
            this.fish = fish;
        }
