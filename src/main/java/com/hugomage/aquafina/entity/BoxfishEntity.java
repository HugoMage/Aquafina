...
public class BoxfishEntity extends AbstractGroupFishEntity {
    public BoxfishEntity(EntityType<? extends BoxfishEntity> p_i49856_1_, World p_i49856_2_) {
        super(p_i49856_1_, p_i49856_2_);
    }
    private static final DataParameter<Integer> VARIANT = EntityDataManager.defineId(BoxfishEntity.class, DataSerializers.INT);
    ...
    public ItemStack getPickedResult(RayTraceResult target) {
        return new ItemStack(RegistryHandler.BOXFISH_SPAWN_EGG.get());
    }
    ...
    protected ItemStack getBucketItemStack()  {
        return new ItemStack(RegistryHandler.BOXFISH_BUCKET.get());
    }
