package com.hugomage.aquafina.Tags;
...
public class AquafinaOreFeatureConfig {
    ...
    public AquafinaOreFeatureConfig(RuleTest p_i241989_1_, BlockState p_i241989_2_, int p_i241989_3_) {
    ...
    public static final class FillerBlockType {
        public static final RuleTest SAND = new TagMatchRuleTest(BlockTags.SAND);
    }
}
