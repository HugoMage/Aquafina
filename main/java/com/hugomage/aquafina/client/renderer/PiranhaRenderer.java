...
import com.hugomage.aquafina.client.model.PiranhaModel;
...
public class PiranhaRenderer extends MobRenderer<PiranhaEntity, PiranhaModel<PiranhaEntity>> {
    ...
    protected static final ResourceLocation TEXTURE = new ResourceLocation(Aquafina.MOD_ID, "textures/entity/piranha.png");


    public PiranhaRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn, new PiranhaModel<>(), 0.2F);
    }
