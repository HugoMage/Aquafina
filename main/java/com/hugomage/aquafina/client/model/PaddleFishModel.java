...
public class PaddleFishModel<T extends PaddleFish> extends EntityModel<T>  {
    ...
    public PaddleFishModel() {
        ...
        left_fin.setPos(3.0F, 2.0F, -1.0F);
        ...
        cube_r1.texOffs(24, 6).addBox(0.0F, 0.0F, -1.0F, 3.0F, 0.0F, 3.0F, 0.0F, false);

        right_fin = new ModelRenderer(this);
        right_fin.setPos(-3.0F, 2.0F, -1.0F);
        ...
        cube_r2.texOffs(20, 24).addBox(-3.0F, 0.0F, -1.0F, 3.0F, 0.0F, 3.0F, 0.0F, false);

        body = new ModelRenderer(this);
        body.setPos(0.0F, 0.0F, 0.0F);
        fishe.addChild(body);
        body.texOffs(0, 0).addBox(-3.0F, -3.0F, -6.0F, 6.0F, 5.0F, 11.0F, 0.0F, false);
        body.texOffs(24, 0).addBox(-1.0F, -3.0F, -10.0F, 2.0F, 1.0F, 4.0F, 0.0F, false);
        body.texOffs(19, 17).addBox(-2.0F, -3.0F, -15.0F, 4.0F, 1.0F, 5.0F, 0.0F, false);

        cube_r3 = new ModelRenderer(this);
        cube_r3.setPos(0.0F, -3.0F, 0.0F);
        body.addChild(cube_r3);
        setRotationAngle(cube_r3, -0.1309F, 0.0F, 0.0F);
        cube_r3.texOffs(0, 0).addBox(0.0F, -3.0F, 0.0F, 0.0F, 3.0F, 4.0F, 0.0F, false);

        tail = new ModelRenderer(this);
        tail.setPos(0.0F, -1.0F, 5.0F);
        fishe.addChild(tail);
        tail.texOffs(0, 17).addBox(-2.0F, -2.0F, 0.0F, 4.0F, 4.0F, 5.0F, 0.0F, false);
        tail.texOffs(0, 17).addBox(0.0F, 2.0F, 2.0F, 0.0F, 2.0F, 2.0F, 0.0F, false);

        tail_fin = new ModelRenderer(this);
        tail_fin.setPos(0.0F, 0.0F, 5.0F);
        tail.addChild(tail_fin);
        tail_fin.texOffs(13, 24).addBox(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 6.0F, 0.0F, false);
    }
