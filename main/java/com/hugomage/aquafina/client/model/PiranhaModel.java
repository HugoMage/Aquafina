...
import com.hugomage.aquafina.entity.PiranhaEntity;
...
public class PiranhaModel<T extends PiranhaEntity> extends EntityModel<T>  {
	...
	public PiranhaModel() {
        ...
        fishe.setPos(0.0F, 22.0F, -2.0F);


        body = new ModelRenderer(this);
        body.setPos(0.0F, 0.0F, 0.0F);
        fishe.addChild(body);
        body.texOffs(0, 0).addBox(-1.0F, -3.0F, -3.0F, 2.0F, 5.0F, 6.0F, 0.0F, false);
        body.texOffs(0, 0).addBox(-1.0F, 0.0F, -4.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);

        tail = new ModelRenderer(this);
        tail.setPos(0.0F, 0.0F, 3.0F);
        fishe.addChild(tail);
        tail.texOffs(0, 0).addBox(0.0F, -2.0F, 0.0F, 0.0F, 3.0F, 3.0F, 0.0F, false);

        fins = new ModelRenderer(this);
        fins.setPos(0.0F, 0.0F, 1.0F);
        fishe.addChild(fins);
        fins.texOffs(10, 1).addBox(0.0F, -4.0F, -1.0F, 0.0F, 1.0F, 2.0F, 0.0F, false);
        fins.texOffs(0, 8).addBox(0.0F, 1.0F, 0.0F, 0.0F, 2.0F, 3.0F, 0.0F, false);
        ...
        cube_r1.texOffs(10, 0).addBox(0.0F, -1.0F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, false);
        ...
        cube_r2.texOffs(6, 9).addBox(0.0F, -1.0F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, false);
    }
