...
public class GuitarSharkEntity extends AbstractGroupFishEntity {
    public GuitarSharkEntity(EntityType<? extends GuitarSharkEntity> p_i49856_1_, World p_i49856_2_) {
        super(p_i49856_1_, p_i49856_2_);
        this.moveControl = new MoveHelperController(this);
        this.setPathfindingMalus(PathNodeType.WATER, 1.0F);
        this.maxUpStep = 0.0f;
    }
    private static final DataParameter<Integer> VARIANT = EntityDataManager.defineId(GuitarSharkEntity.class, DataSerializers.INT);
    ...
    public ItemStack getPickedResult(RayTraceResult target) {
        return new ItemStack(RegistryHandler.GUITAR_SPAWN_EGG.get());
    }
    protected ItemStack getBucketItemStack() {
        return null;
    }
    static class MoveHelperController extends MovementController {
        public final GuitarSharkEntity ray;

        MoveHelperController(GuitarSharkEntity ray) {
            super(ray);
            this.ray = ray;
        }
        public void tick() {
    ...
    static class SwimGoal extends RandomSwimmingGoal {
        private final GuitarSharkEntity fish;

        public SwimGoal(GuitarSharkEntity fish) {
            super(fish, 2.0D, 40);
            this.fish = fish;
        }
