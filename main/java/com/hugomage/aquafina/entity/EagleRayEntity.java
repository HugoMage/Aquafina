...
public class EagleRayEntity extends AbstractGroupFishEntity {
    public EagleRayEntity(EntityType<? extends EagleRayEntity> p_i49856_1_, World p_i49856_2_) {
        super(p_i49856_1_, p_i49856_2_);
    }
    private static final DataParameter<Integer> VARIANT = EntityDataManager.defineId(EagleRayEntity.class, DataSerializers.INT);
    ...
    static class SwimGoal extends RandomSwimmingGoal {
        private final EagleRayEntity fish;

        public SwimGoal(EagleRayEntity fish) {
            super(fish, 2.0D, 40);
            this.fish = fish;
        }
