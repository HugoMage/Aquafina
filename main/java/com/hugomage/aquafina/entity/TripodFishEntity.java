...
public class TripodFishEntity extends AbstractGroupFishEntity {
    public TripodFishEntity(EntityType<? extends TripodFishEntity> p_i49856_1_, World p_i49856_2_) {
        super(p_i49856_1_, p_i49856_2_);
        this.moveControl = new MoveHelperController(this);
        this.setPathfindingMalus(PathNodeType.WATER, 1.0F);
        this.maxUpStep = 0.0f;
    }
    private static final DataParameter<Integer> VARIANT = EntityDataManager.defineId(TripodFishEntity.class, DataSerializers.INT);
    ...
    public ItemStack getPickedResult(RayTraceResult target) {
        return new ItemStack(RegistryHandler.TRIPOD_FISH_SPAWN_EGG.get());
    }
    @Override
    protected ItemStack getBucketItemStack()  {
        return new ItemStack(RegistryHandler.TRIPOD_FISH_BUCKET.get());
    }

    static class MoveHelperController extends MovementController {
        public final TripodFishEntity ray;

        MoveHelperController(TripodFishEntity ray) {
            super(ray);
            this.ray = ray;
        }
        public void tick() {
    ...
    static class SwimGoal extends RandomSwimmingGoal {
        private final TripodFishEntity fish;

        public SwimGoal(TripodFishEntity fish) {
            super(fish, 2.0D, 40);
            this.fish = fish;
        }
