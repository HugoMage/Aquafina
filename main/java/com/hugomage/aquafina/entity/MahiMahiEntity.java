...
public class MahiMahiEntity extends AbstractGroupFishEntity {
    public MahiMahiEntity(EntityType<? extends MahiMahiEntity> p_i49856_1_, World p_i49856_2_) {
        super(p_i49856_1_, p_i49856_2_);
    }
    private static final DataParameter<Integer> VARIANT = EntityDataManager.defineId(MahiMahiEntity.class, DataSerializers.INT);
    ...
    static class SwimGoal extends RandomSwimmingGoal {
        private final MahiMahiEntity fish;

        public SwimGoal(MahiMahiEntity fish) {
            super(fish, 2.0D, 40);
            this.fish = fish;
        }
