...
public class PaddleFish extends AbstractGroupFishEntity {
    public PaddleFish(EntityType<? extends PaddleFish> p_i49856_1_, World p_i49856_2_) {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(1, new PaddleFish.SwimGoal(this));
    ...
    public ItemStack getPickedResult(RayTraceResult target) {
        return new ItemStack(RegistryHandler.PADDLEFISH_SPAWN_EGG.get());
    }
    static class SwimGoal extends RandomSwimmingGoal {
        private final PaddleFish fish;

        public SwimGoal(PaddleFish fish) {
            super(fish, 2.0D, 40);
            this.fish = fish;
        }
